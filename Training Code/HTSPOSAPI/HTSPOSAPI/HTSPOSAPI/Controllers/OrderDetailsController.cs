...
namespace HTSPOSAPI.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        {
            if (id != orderDetails.OrderItemId)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<OrderDetails>> PostOrderDetails(OrderDetails orderDetails)
        {
            ...
            return CreatedAtAction("GetOrderDetails", new { id = orderDetails.OrderItemId }, orderDetails);
        }
        ...
        {
            return _context.orderDetails.Any(e => e.OrderItemId == id);
        }
    }
}
